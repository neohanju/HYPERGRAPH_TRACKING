...
CSGSmooth::CSGSmooth(int span, int degree, std::vector<double> *initialData)
	: span_(span)
	, degree_(degree)
	, precomputedQsets_(NULL)
{
...
int CSGSmooth::Insert(double newData)
{
	data_.push_back(newData);	
	return Smoothing();
}

int CSGSmooth::Insert(std::vector<double> &queueNewData)
{
	data_.insert(data_.end(), queueNewData.begin(), queueNewData.end());
	return Smoothing();
}

int CSGSmooth::ReplaceBack(double replaceData)
{
...
void CSGSmooth::SetSmoother(std::deque<double> &data, std::deque<double> &smoothedData, int span, int degree)
{
	data_ = data;
...
double CSGSmooth::GetResult(int pos)
{
	assert(pos < smoothedData_.size());
	return smoothedData_[pos];
}

std::vector<double> CSGSmooth::GetResults(int startPos, int endPos)
{
...
void CSGSmooth::GetSmoother(std::deque<double> &data, std::deque<double> &smoothedData, int &span, int &degree)
{
	data = data_;
...
bool CSGSmooth::UpdateQ(int windowSize)
{
...
Qset CSGSmooth::CalculateQ(int windowSize, int degree)
{
	Qset resutQ_;
...
std::vector<double> CSGSmooth::Filter(std::vector<double> &coefficients, std::deque<double> &data, int startPos)
{
